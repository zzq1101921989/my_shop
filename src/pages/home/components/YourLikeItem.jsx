...
export default function YourLikeItem (props) {

    return (
        <div className={styl.yourLikeItemWrapper}>
            <div className={styl.content}>
                <div className={styl.youImageWrapper}>
                    <div className={styl.LazyLoad + " " + styl['is-visible']}>
                        <img className={styl.yourImage} src={props.small_image} alt={props.spec} />
                </div>
                    </div>
                    <div className={styl.yourInfoWrapper}>
                        <div className={styl.article}>
                            <span className={styl.nameText}>{props.name}</span>
                        </div>
                        <div className={styl.tagsWrapper}>
                            <div className={styl.H1B9Rvu}></div>
                        </div>
                        <div className={styl.yourPriceWrapper}>
                            <div className={styl.youPriceInfo}>
                                <div className={styl.pricePart}>
                                    <div className={styl.price}>
                                        ￥<span className={styl.f34}>{props.origin_price}</span>
                            </div>
                                    <div className={styl.originPrice}>￥{props.price}</div>
                                </div>
                            </div>
                            <div className={styl.yourIconCartWrapper}>
                                <svg viewBox="0 0 52 52" className={styl.icon + " " + styl.youIconCart}>
                                    <defs>
