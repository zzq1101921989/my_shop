...
export default function FlashSaleItem (props) {
    ...
    return (
        <div className={styl.bottomWrapper}>
            <div className={styl.bottomItemWrapper}>
                <div className={styl.bottomItemImageWrapper}>
                    <img 
                        className={styl.bottomItemImage} 
                        src={small_image} 
                        alt={spec} 
                    />
                </div>
                <div>
                    <div className={styl.name}>{product_name}</div>
                                ...
                                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    <g transform="translate(-678.000000, -2742.000000)">
                                        <g transform="translate(678.000000, 2742.000000)">
                                            ...
                                            <path stroke="#FFFFFF" strokeWidth="2.6" strokeLinecap="round" d="M12.1333333,13.8666667 L13.6768756,13.8666667 C15.4621209,13.8666667 16.9554584,15.222463 17.1274221,16.9994069 L18.2224287,28.314386 C18.4068512,30.2200702 20.1012175,31.6154285 22.0069016,31.431006 C22.0111286,31.4305969 22.0153548,31.4301801 22.0195802,31.4297555 L33.2997819,30.296256 C34.7947282,30.1460352 36.0227397,29.0499108 36.3411182,27.581556 L37.8958814,20.4110205 C38.0987345,19.4754663 37.5047629,18.5526049 36.5692087,18.3497518 C36.3853963,18.3098964 36.1963225,18.3002236 36.0094025,18.3211126 L22.8968424,19.7864909"></path>
                                        </g>
                                    </g>
                                </g>
                            </svg>
